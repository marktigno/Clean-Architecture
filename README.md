...
## Frontend
A React + TypeScript (Vite) client that consumes the WebAPI's To-Do endpoints lives in [`frontend/`](./frontend). See [`frontend/README.md`](./frontend/README.md) for setup and run instructions.